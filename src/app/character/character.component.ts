...
const BIS_LOADERS: Partial<Record<string, () => Promise<{ bisList: BisEntry[] }>>> = {
  'warrior-fury':         () => import('../../../scripts/bis-baker/t6/warrior-fury') as Promise<any>,
  'warrior-arms':         () => import('../../../scripts/bis-baker/t6/warrior-arms') as Promise<any>,
  'warrior-protection':   () => import('../../../scripts/bis-baker/t6/warrior-protection') as Promise<any>,
  'paladin-holy':         () => import('../../../scripts/bis-baker/t6/paladin-holy') as Promise<any>,
  'paladin-protection':   () => import('../../../scripts/bis-baker/t6/paladin-protection') as Promise<any>,
  'paladin-retribution':  () => import('../../../scripts/bis-baker/t6/paladin-retribution') as Promise<any>,
  'hunter-bm':            () => import('../../../scripts/bis-baker/t6/hunter-bm') as Promise<any>,
  'hunter-mm':            () => import('../../../scripts/bis-baker/t6/hunter-mm') as Promise<any>,
  'hunter-survival':      () => import('../../../scripts/bis-baker/t6/hunter-survival') as Promise<any>,
  'druid-balance':        () => import('../../../scripts/bis-baker/t6/druid-balance') as Promise<any>,
  'druid-bear':           () => import('../../../scripts/bis-baker/t6/druid-bear') as Promise<any>,
  'druid-cat':            () => import('../../../scripts/bis-baker/t6/druid-cat') as Promise<any>,
  'druid-restoration':    () => import('../../../scripts/bis-baker/t6/druid-restoration') as Promise<any>,
  'rogue':                () => import('../../../scripts/bis-baker/t6/rogue') as Promise<any>,
  'warlock-affliction':   () => import('../../../scripts/bis-baker/t6/warlock-affliction') as Promise<any>,
  'warlock-demonology':   () => import('../../../scripts/bis-baker/t6/warlock-demonology') as Promise<any>,
  'warlock-destruction':  () => import('../../../scripts/bis-baker/t6/warlock-destruction') as Promise<any>,
  'mage-arcane':          () => import('../../../scripts/bis-baker/t6/mage-arcane') as Promise<any>,
  'mage-fire':            () => import('../../../scripts/bis-baker/t6/mage-fire') as Promise<any>,
  'mage-frost':           () => import('../../../scripts/bis-baker/t6/mage-frost') as Promise<any>,
  'priest-holy':          () => import('../../../scripts/bis-baker/t6/priest-holy') as Promise<any>,
  'priest-shadow':        () => import('../../../scripts/bis-baker/t6/priest-shadow') as Promise<any>,
  'shaman-elemental':     () => import('../../../scripts/bis-baker/t6/shaman-elemental') as Promise<any>,
  'shaman-enhancement':   () => import('../../../scripts/bis-baker/t6/shaman-enhancement') as Promise<any>,
  'shaman-restoration':   () => import('../../../scripts/bis-baker/t6/shaman-restoration') as Promise<any>,
};
